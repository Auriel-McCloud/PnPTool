...
**KI und CRITTER sind seit 20.09.2026 KEINE Begleiter-Arten mehr** — beide
leben als echte `Person`-Knoten in `app/entities/` mit dem vollen
Charakterblatt statt dieses Drohne/Fahrzeug-Blatts (`istCritter`/`istKI`,
Einfluss-Kanten in `app/entities/repository.py::person_einfluss_*`).
"""
